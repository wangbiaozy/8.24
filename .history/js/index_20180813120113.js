...
$(function () {
    ...
    $('#look_blacklist').on('click',function(){
        ...
        $blacklist.slideToggle('normal',function(){
            if($(this).css('display') === 'block'){
                $('#look_blacklist').addClass('act');
                $('.arrow_m').addClass('act');
            }else{
                $('#look_blacklist').removeClass('act');
                $('.arrow_m').removeClass('act');
            }
        });
    });
});